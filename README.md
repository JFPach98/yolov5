...
- Las labels tienen que estar en formato yolo darknet. Para el formato, se coloca el archivo .csv en este repositorio y se corre en la consola el siguiente script:
